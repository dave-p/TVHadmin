	...
	foreach($chans as $c) {
	 ...
	 <div class='spacer' style='width: $spc%;'>
	  <img src='images/spacer.gif' width=1 height=1 alt=''>
		...
		if (isset($p['onNow'])) echo "<a href='$view_url/play/ticket/stream/channel/{$c['uuid']}?title={$c['name']}' download='{$c['uuid']}.m3u'><div class='item $colour' style='width: $pc%;' title='$subtitle'>{$p['title']}</div></a>";
	      ...
	      echo "<a href='$view_url/play/ticket/stream/channel/{$c['uuid']}?title={$c['name']}' download='{$c['uuid']}.m3u'><div class='item onNow' style='width: 98%;'>No EPG Available</div></a>";
	    }
	    echo "
      </td>
     </tr>";
